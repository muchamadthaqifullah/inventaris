...
if (isset($_POST['update'])) {
    ...
    $updatedata = mysqli_query($conn, "UPDATE sstock_brg SET nama='$nama', jenis='$jenis', merk='$merk', satuan='$satuan', lokasi='$lokasi', department='$department', serialnumber='$serialnumber' WHERE idx='$idx'");
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header" style="text-align: center;">
                <a href="index.php"><img src="../cbi2.png" alt="logo" width="30%"></a>
            </div>
            <div class="main-menu">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right" style="color:black; padding:0px;">
                            <img src="bg.jpg" width="220px" class="user-name dropdown-toggle" data-toggle="dropdown" \>
                        </div>
                    </div>
                </div>
            </div>
                                                        ...
                                                        <div class="modal-content">
                                                            <form method="post">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <select id="lokasi" name="lokasi" class="custom-select form-control">
                                                                        <option value="">Pilih lokasinya</option>
                                                                        <option value="PT. Citra Borneo Indah" <?php if ($p['lokasi'] === 'PT. Citra Borneo Indah') echo 'selected'; ?>>PT. Citra Borneo Indah</option>
                                                                        <option value="PT. Sawit Sumbermas Sarana" <?php if ($p['lokasi'] === 'PT. Sawit Sumbermas Sarana') echo 'selected'; ?>>PT. Sawit Sumbermas Sarana</option>
                                                                        <option value="PT. Citra Borneo Utama" <?php if ($p['lokasi'] === 'PT. Citra Borneo Utama') echo 'selected'; ?>>PT. Citra Borneo Utama</option>
                                                                    </select>
                                                                    <input type="hidden" name="idbrg" value="<?= $idb; ?>">

                                                                    <label for="department">Department</label>
                                                                    <select id="department" name="department" class="custom-select form-control">
                                                                        <option value="">Pilih departemennya</option>
                                                                        <option value="IT - Support" <?php if ($p['department'] === 'IT - Support') echo 'selected'; ?>>IT - Support</option>
                                                                        <option value="IT - Network" <?php if ($p['department'] === 'IT - Network') echo 'selected'; ?>>IT - Network</option>
                                                                        <option value="IT - Development" <?php if ($p['department'] === 'IT - Development') echo 'selected'; ?>>IT - Development</option>
                                                                    </select>

                                                                    <label for="serialnumber">Serial Number</label>
                                                                    <input type="number" id="serialnumber" name="serialnumber" class="form-control" value="<?php echo $p['serialnumber'] ?>">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form method="post">
                                                                <!-- Modal Header -->
                                                                <div class="modal-header">
                                                                    <h4 class="modal-title">Hapus Barang <?php echo $p['nama'] ?> - <?php echo $p['jenis'] ?> - <?php echo $p['department'] ?></h4>
                                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                                </div>
                    ...
                    <form action="tmb_brg_act.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select name="lokasi" class="custom-select form-control">
                                <option value="">Pilih lokasinya</option>
                                <option value="PT. Citra Borneo Indah">PT. Citra Borneo Indah</option>
                                <option value="PT. Sawit Sumbermas Sarana">PT. Sawit Sumbermas Sarana</option>
                                <option value="PT. Citra Borneo Utama">PT. Citra Borneo Utama</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Departemen</label>
                            <select name="department" class="custom-select form-control">
                                <option selected>Pilih departemennya</option>
                        ...
                        <div class="form-group">
                            ...
                            <input name="serialnumber" type="number" min="0" class="form-control" placeholder="serialnumber">
                        </div>
