...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata1 = mysqli_query($conn,"update sbrg_masuk set jumlah='$jumlah', penerima='$penerima',keterangan='$keterangan', tgl='$tanggal', department='$department', serialnumber='$serialnumber' where id='$id'");
							...
							<form action="barang_keluar_act.php" method="post">
								...
								<div class="form-group">
                                    ...
                                    <select name="barang" class="custom-select form-control">
                                        ...
                                        <?php
                                        $query = "SELECT * FROM sstock_brg ORDER BY nama ASC";
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            <option value="<?php echo $idx ?>">
                                                <?php echo "$nama $merk $jenis --- Stock : $stock" ?>
                                            </option>
                                            <?php
                                        }
                                        ?>
