...
if (isset($_POST['update'])) {
    ...
    if ($jumlah >= $qtyskrg) {
        ...
        $updatedata1 = mysqli_query($conn, "update sbrg_masuk set tgl='$tanggal',jumlah='$jumlah',keterangan='$keterangan',department='$department',serialnumber='$serialnumber' where id='$id'");
        ...
        $updatedata = mysqli_query($conn, "update sbrg_masuk set tgl='$tanggal', jumlah='$jumlah', keterangan='$keterangan',department='$department',serialnumber='$serialnumber' where id='$id'");
                                                            ...
                                                            <div class="modal-content">
                                                                <form method="post">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <input type="text" id="department" name="department" class="form-control" value="<?php echo $b['department'] ?>">

                                                                        <label for="serialnumber">Serial Number</label>
                                                                        <input type="number" id="serialnumber" name="serialnumber" class="form-control" value="<?php echo $b['serialnumber'] ?>">
                ...
                <div class="modal-body">
                    <form action="barang_masuk_act.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input name="dpt" type="text" class="form-control" placeholder="Department">
                        </div>
                        <div class="form-group">
                            <label>Serial Number</label>
                            <input name="sn" type="text" class="form-control" placeholder="SerialNumber">
                        </div>
                </div>
                <div class="modal-footer">
